...
insert into user(name,code,password,role) VALUES
('吴大山',2014110001,md5('2014110001'),1),
('张大宝',2014110002,md5('2014110002'),1),
('王淑芬',2014110003,md5('2014110003'),1),
('王玉芬',2014110004,md5('2014110004'),1),
('李美丽',2014110005,md5('2014110005'),1),
('李春华',2014110006,md5('2014110006'),1),
('张二狗',2014110007,md5('2014110007'),1);
